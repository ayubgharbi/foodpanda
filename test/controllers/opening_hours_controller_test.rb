...
class OpeningHoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opening_hour" do
    assert_difference('OpeningHour.count') do
      post opening_hours_url, params: { opening_hour: { day: @opening_hour.day, end_time: @opening_hour.end_time, restaurant_id: @opening_hour.restaurant_id, start_time: @opening_hour.start_time } }
    end
  ...
  test "should update opening_hour" do
    patch opening_hour_url(@opening_hour), params: { opening_hour: { day: @opening_hour.day, end_time: @opening_hour.end_time, restaurant_id: @opening_hour.restaurant_id, start_time: @opening_hour.start_time } }
